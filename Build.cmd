...
echo Running tests.
call %dotnet% test XmpCore.Tests --configuration %cfg% --no-build
...
call %dotnet% pack XmpCore --configuration %cfg% --output artifacts --no-build
call %dotnet% pack XmpCore-Signed --configuration %cfg% --output artifacts --no-build
